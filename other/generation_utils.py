...
class GenerationMixin:
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
        self, input_ids, per_input_ids, per_attention_mask, model_kwargs
    ) -> Dict[str, Any]:
        outputs = self.forward(input_ids=input_ids, per_input_ids=per_input_ids, per_attention_mask=per_attention_mask,
        generate=True, **model_kwargs)

        
        model_kwargs["encoder_outputs"]: ModelOutput = outputs["encoder_outputs"]
        model_kwargs["latent_variable"]: ModelOutput = outputs["latent_variable"]
    ...
    def generate(
        ...
        per_input_ids: Optional[bool] = None,
        per_attention_mask: Optional[bool] = None,
        **model_kwargs,
        ...
        if self.config.is_encoder_decoder:
            ...
            model_kwargs = self._prepare_encoder_decoder_kwargs_for_generation(encoder_input_ids, per_input_ids, per_attention_mask, model_kwargs)
